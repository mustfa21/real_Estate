                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-4 col-12">
                            <div class="form-group">
                                <label for="from_date"><?php echo app('translator')->get('Transaction Id'); ?></label>
                        ...
                        <div class="col-md-4 col-lg-4 col-12">
                            <div class="form-group">
                                <label for="from_date"><?php echo app('translator')->get('User'); ?></label>
                        ...
                        <div class="col-md-4 col-lg-4 col-12">
                            <div class="form-group">
                                <label for="from_date"><?php echo app('translator')->get('Remark'); ?></label>
                        ...
                        <div class="col-md-4 col-lg-4 col-12">
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn waves-effect waves-light btn-primary w-100"><i class="fas fa-search"></i> <?php echo app('translator')->get('Search'); ?></button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <table class="categories-show-table table table-hover table-striped table-bordered">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td data-label="<?php echo app('translator')->get('Remark'); ?>"><?php echo app('translator')->get($row->remarks); ?></td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\project1\resources\views/admin/transaction/index.blade.php ENDPATH**/ ?>