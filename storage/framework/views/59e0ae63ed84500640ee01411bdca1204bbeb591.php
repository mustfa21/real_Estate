...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <?php if($loop->index == 0): ?>
                                            <div class="col-md-3 col-lg-3">
                                                <div class="form-group">
                                                    <label class="font-weight-bold"><?php echo app('translator')->get('Address'); ?> <span
...
unset($__errorArgs, $__bag); ?>
                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('Featured Property'); ?></label>
                                            ...
                                            <div class="col-md-3 col-xl-3">
                                                <div class="form-group">
                                                    <label><?php echo app('translator')->get('Can investors see available funds?'); ?></label>
                                                    <div class="custom-switch-btn">
                                                        <input type='hidden' value='1'
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('Total Investment Amount'); ?></label>
                                                <div class="input-group">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3 howManyTimes <?php echo e(old('is_return_type') == "0" ? '' : 'd-none'); ?>">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('How many times?'); ?></label>
                                                <div class="input-group">
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('After how many days?'); ?></label>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('Can Share Investment?'); ?></label>
                                                <div class="custom-switch-btn">
                                                    <input type='hidden' value='1'
                                        ...
                                        <div class="col-md-3 col-xl-3">
                                            <div class="form-group">
                                                <label><?php echo app('translator')->get('Expire Date'); ?></label>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\project1\resources\views/admin/property/create.blade.php ENDPATH**/ ?>