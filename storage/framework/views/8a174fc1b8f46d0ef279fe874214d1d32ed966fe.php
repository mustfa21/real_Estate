<?php $__env->startSection('title'); ?>
    <?php echo app('translator')->get('Address List'); ?>
        ...
        <div class="card-body">
            <?php if(adminAccessRoute(config('role.manage_property.access.add'))): ?>
                <div class="media mb-4 float-right">
                    <a href="<?php echo e(route('admin.addressCreate')); ?>" class="btn btn-sm btn-primary btn-rounded mr-2">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $addresses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                <span
                                    class="custom-badge <?php echo e(@$item->status == 1 ? 'bg-success' : 'bg-danger'); ?>"><?php echo app('translator')->get(@$item->status == 1 ? 'Active' : 'Deactive'); ?></span>
                            </td>
                            ...
                            <?php if(adminAccessRoute(config('role.manage_property.access.edit')) == true || adminAccessRoute(config('role.manage_property.access.delete')) == true): ?>
                                <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                    <?php if(adminAccessRoute(config('role.manage_property.access.edit'))): ?>
                                        <a href="<?php echo e(route('admin.addressEdit',$item->id)); ?>"
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\project1\resources\views/admin/address/index.blade.php ENDPATH**/ ?>