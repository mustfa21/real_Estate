...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card card-primary card-form m-0 m-md-4 my-4 m-md-0">
        <div class="card-body">
            ...
            <a href="<?php echo e(route('admin.language.index')); ?>" class="btn btn-sm btn-primary btn-rounded float-right mb-3"><i
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\project1\resources\views/admin/language/create.blade.php ENDPATH**/ ?>